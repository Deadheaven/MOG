...
def main():
    ...
    mog2 = cv2.createBackgroundSubtractorMOG2(history=0, varThreshold=60, detectShadows=True)
    ...
    while True:
        ...
        for contour in contours:
            if cv2.contourArea(contour) > 500:  # Filter small areas
                ...
                cv2.putText(frame_resized, f"Area: {cv2.contourArea(contour)}", 
        ...
        bottom_row = np.hstack((background_resized, frame_diff))  # Concatenate second row
